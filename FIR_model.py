...
class Model:
    ...
    def __init__(self, inp_int: int = 15, l1_w: int = 16, l2_w: int = 16, n_test_samples: int = 190,
        ...
        if weights < 2 * n_test_samples:
            ...
            self.model = tf.keras.wrappers.scikit_learn.KerasClassifier(build_fn=build_model,
                                                                        inp_int_=inp_int,
                                                                        l1_w_=l1_w,
                                                                        l2_w_=l2_w,
                                                                        epochs=self.epoch,
    ...
    def rank(self, x_test: np.ndarray, y_test: np.ndarray, feats: np.ndarray) -> list:
        """
